...
/**
 * Represents a Name string that can contain digits and special characters.
 *
...
final class NameSpecial implements ValueObject
{
    ...
    public const REGEX_CHAR = "[-_\#~@ 'a-zA-ZÀ-ÖØ-öø-ÿ0-9]";
    ...
    public function equals(NameSpecial $name) : bool
    {
