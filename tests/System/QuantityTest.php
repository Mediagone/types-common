...
final class QuantityTest extends TestCase
{
    ...
    public function test_equality_between_quantities() : void
    {
        $q1 = Quantity::fromInt(20);
        $q2 = Quantity::fromInt(20);
    ...
    public function test_inequality_between_quantities() : void
    {
        $q1 = Quantity::fromInt(20);
        $q2 = Quantity::fromInt(13);
    ...
    public function test_can_add_another_quantity() : void
    {
        $q1 = Quantity::fromInt(20);
        $q2 = Quantity::fromInt(13);
    ...
    public function test_can_subtract_another_quantity() : void
    {
        $q1 = Quantity::fromInt(20);
        $q2 = Quantity::fromInt(13);
    ...
    public function test_cannot_subtract_greater_quantity() : void
    {
        $q1 = Quantity::fromInt(20);
        $q2 = Quantity::fromInt(13);
