...
/**
 * @covers \Mediagone\Types\Common\Crypto\Sha512
 */
final class Sha512Test extends TestCase
{
    ...
    public function test_can_be_created_from_token() : void
    {
        ...
        self::assertSame(Sha512::HEX_LENGTH, strlen((string)Sha512::fromString((string)$token)));
    }
    ...
    {
        $token = RandomToken::random();
        $hash1 = Sha512::fromString((string)$token);
        $hash2 = Sha512::fromString((string)$token);
    ...
    {
        $hash1 = Sha512::fromString((string)RandomToken::random());
        $hash2 = Sha512::fromString((string)RandomToken::random());
    ...
    {
        $token = Sha512::fromHash($hashString);
    
        self::assertSame($hashString, (string)$token);
        self::assertSame(Sha512::HEX_LENGTH, strlen((string)$token));
    }
    ...
    public function test_cannot_be_created_from_invalid_hex_string(string $invalidHashString) : void
    {
        ...
        Sha512::fromHash($invalidHashString);
    }
    ...
    public function test_can_be_created_from_binary_string() : void
    {
        ...
        $tokenHash = Sha512::fromBinaryString($bin);
    ...
    public function test_can_be_converted_to_json() : void
    {
        ...
        $hash = Sha512::fromString((string)$token);
    ...
    public function test_can_be_cast_to_binary_string() : void
    {
        ...
        self::assertSame(Sha512::BINARY_LENGTH, strlen($bin));
    ...
    {
        self::assertTrue(Sha512::isValueValid($hexString));
    }
    ...
    {
        self::assertFalse(Sha512::isValueValid($invalidHexString));
    }
    ...
    {
        $token1 = Sha512::fromHash('6ec991de3f13a604d3eef9651b47f966d798b05b1e9f5c9fee940ead094e3579cc25a5cd9ad9f80a0caec92b95ff54d67180448080f2c40fae6605e1877f9c4e');
        $token2 = Sha512::fromHash('6ec991de3f13a604d3eef9651b47f966d798b05b1e9f5c9fee940ead094e3579cc25a5cd9ad9f80a0caec92b95ff54d67180448080f2c40fae6605e1877f9c4e');
    ...
    {
        $token1 = Sha512::fromHash('6ec991de3f13a604d3eef9651b47f966d798b05b1e9f5c9fee940ead094e3579cc25a5cd9ad9f80a0caec92b95ff54d67180448080f2c40fae6605e1877f9c4e');
        $token2 = Sha512::fromHash('b299d0ac5eb4189a2d504bb110be4f0743b08fb70b492b2b4eacf40db445a0e3537c0011253f86c9d4b3158849e8fa9246a7745e415ac04fb8f4e3eb0d88c522');
