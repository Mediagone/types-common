...
/**
 * @covers \Mediagone\Types\Common\Crypto\RandomTokenHash
 */
final class RandomTokenHashTest extends TestCase
{
    //========================================================================================================
    // Tests
    //========================================================================================================
    ...
    public function test_can_be_created_from_token() : void
    {
        ...
        self::assertSame(RandomTokenHash::HEX_LENGTH, strlen((string)RandomTokenHash::fromToken($token)));
    }
    ...
    {
        $token = RandomToken::random();
        $hash1 = RandomTokenHash::fromToken($token);
        $hash2 = RandomTokenHash::fromToken($token);
    ...
    {
        $hash1 = RandomTokenHash::fromToken(RandomToken::random());
        $hash2 = RandomTokenHash::fromToken(RandomToken::random());
    ...
    {
        $token = RandomTokenHash::fromHash($hashString);
    
        self::assertSame($hashString, (string)$token);
        self::assertSame(RandomTokenHash::HEX_LENGTH, strlen((string)$token));
    }
    ...
    public function test_cannot_be_created_from_invalid_hex_string(string $invalidHashString) : void
    {
        ...
        RandomTokenHash::fromHash($invalidHashString);
    }
    ...
    public function test_can_be_converted_to_json() : void
    {
        ...
        $hash = RandomTokenHash::fromToken($token);
    ...
    public function test_can_be_cast_to_binary_string() : void
    {
        ...
        self::assertSame(RandomTokenHash::BINARY_LENGTH, strlen($bin));
    ...
    {
        self::assertTrue(RandomTokenHash::isValueValid($hexString));
    }
    ...
    {
        self::assertFalse(RandomTokenHash::isValueValid($invalidHexString));
    }
    ...
    public function test_can_verify_tokens() : void
    {
        ...
        $hash = RandomTokenHash::fromToken($token1);
    ...
    {
        $token1 = RandomTokenHash::fromHash('6ec991de3f13a604d3eef9651b47f966d798b05b1e9f5c9fee940ead094e3579cc25a5cd9ad9f80a0caec92b95ff54d67180448080f2c40fae6605e1877f9c4e');
        $token2 = RandomTokenHash::fromHash('6ec991de3f13a604d3eef9651b47f966d798b05b1e9f5c9fee940ead094e3579cc25a5cd9ad9f80a0caec92b95ff54d67180448080f2c40fae6605e1877f9c4e');
    ...
    {
        $token1 = RandomTokenHash::fromHash('6ec991de3f13a604d3eef9651b47f966d798b05b1e9f5c9fee940ead094e3579cc25a5cd9ad9f80a0caec92b95ff54d67180448080f2c40fae6605e1877f9c4e');
        $token2 = RandomTokenHash::fromHash('b299d0ac5eb4189a2d504bb110be4f0743b08fb70b492b2b4eacf40db445a0e3537c0011253f86c9d4b3158849e8fa9246a7745e415ac04fb8f4e3eb0d88c522');
